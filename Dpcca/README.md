...
- 状态：**测试版 3.0**（2026-09-14 新增多选筛选 / 季度筛选 / 评分室密码锁等）
- 版本里程碑：v1.0.0（2026-09-07）→ v2.1（2026-09-12，公告弹窗）→ v3.0（2026-09-14）
...
> 当前各公开页右上角均已显示「测试版 v3.0」徽标。测试期间数据/功能可能调整，反馈请走 README 渠道。
